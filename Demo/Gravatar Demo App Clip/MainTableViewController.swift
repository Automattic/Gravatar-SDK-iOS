...
class MainTableViewController: UITableViewController, DeepLinkHandling {
    ...
    func handleDeepLink(_ url: URL) {
        navigationController?.pushViewController(DemoQuickEditorViewController(), animated: false)
    }
}
