...
final class UserProfileTests: XCTestCase {
    ...
    func testComprehensiveUserProfileWithBoolsAsStrings() async throws {
        ...
        expectEqual(output: profile.profileURLString, assertion: TestProfile.FullProfile.profileUrl)
        expectEqual(output: profile.preferredUsername, assertion: TestProfile.FullProfile.preferredUsername)
        expectEqual(output: profile.thumbnailURLString, assertion: TestProfile.FullProfile.thumbnailUrl)
    ...
    func testPartialProfile() async throws {
        ...
        expectEqual(output: profile.profileURLString, assertion: TestProfile.PartialProfile.profileUrl)
        expectEqual(output: profile.preferredUsername, assertion: TestProfile.PartialProfile.preferredUsername)
        expectEqual(output: profile.thumbnailURLString, assertion: TestProfile.PartialProfile.thumbnailUrl)
        XCTAssertNotNil(profile.lastProfileEditDate)
    ...
    func testNewlyCreatedProfile() async throws {
        ...
        expectEqual(output: profile.profileURLString, assertion: TestProfile.NewlyCreatedProfile.profileUrl)
        expectEqual(output: profile.preferredUsername, assertion: TestProfile.NewlyCreatedProfile.preferredUsername)
        expectEqual(output: profile.thumbnailURLString, assertion: TestProfile.NewlyCreatedProfile.thumbnailUrl)
...
extension UserProfileTests {
    ...
    private func expectEqual(
        ...
        for (index, account) in output.enumerated() {
            ...
            XCTAssertEqual(account.iconURLString, assertion[index]["iconUrl"] as? String, file: file, line: line)
