...
extension Palette {
    static func testPalette() -> Palette {
        Palette(name: "TestPalette",
                foreground: ForegroundColors(primary: UIColor(red: 90/255, green: 88/255, blue: 88/255, alpha: 1), 
                ...
                avatar: AvatarColors(border: UIColor(red: 9/255, green: 93/255, blue: 154/255, alpha: 1),
                ...
                placeholder: PlaceholderColors(backgroundColor: UIColor(red: 255/255, green: 179/255, blue: 186/255, alpha: 1),
