...
describe Fastlane::Actions::InstallSwiftlintAction do
  ...
  let(:latest_version_response) do
    { "tag_name" => "0.51.0" }.to_json
  end
  ...
  describe '#fetch_latest_release_tag' do
    it 'fetches the latest SwiftLint release tag from GitHub' do
      stub_request(:get, "https://api.github.com/repos/realm/SwiftLint/releases/latest")
  ...
  describe '#download_file' do
    it 'downloads a file and writes it to the specified location' do
      stub_request(:get, "https://github.com/realm/SwiftLint/releases/download/0.51.0/portable_swiftlint.zip")
      ...
      Fastlane::Actions::InstallSwiftlintAction.download_file(
        "https://github.com/realm/SwiftLint/releases/download/0.51.0/portable_swiftlint.zip",
        destination
      )
